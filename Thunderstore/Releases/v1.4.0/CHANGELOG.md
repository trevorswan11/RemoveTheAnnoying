- **1.4.0**
    ...
    - Added a another way to handle the cruiser fix, where the players 'on ship' data is updated instead of having the player teleported. Either one of these can be used. Inspired by digger1213's [Cruiser Improved](https://github.com/digger1213/CruiserImproved/) mod.
